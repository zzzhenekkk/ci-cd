...
2. [Основные темы](#основные-темы)
   - [Часть 1: Настройка gitlab-runner](#часть-1-настройка-gitlab-runner)
   - [Часть 2: Сборка](#часть-2-сборка)
   - [Часть 3: Тест кодстайла](#часть-3-тест-кодстайла)
   - [Часть 4: Интеграционные тесты](#часть-4-интеграционные-тесты)
   - [Часть 5: Этап деплоя](#часть-5-этап-деплоя)
   - [Часть 6: Дополнительно - Уведомления](#часть-6-дополнительно-уведомления)

## Введение

Этот проект посвящен разработке простого CI/CD пайплайна для проекта SimpleBashUtils. Вы научитесь настраивать `gitlab-runner`, автоматизировать сборку, тестирование, а также деплой проекта. Дополнительно будет рассмотрена интеграция уведомлений в CI/CD процессы.

## Основные темы

### Часть 1: Настройка gitlab-runner

Установка и настройка `gitlab-runner` для автоматизации CI/CD процессов.

### Часть 2: Сборка

Автоматизация процесса сборки проекта в CI/CD пайплайне.

### Часть 3: Тест кодстайла

Проверка соответствия кода установленным стандартам с использованием автоматических тестов.

### Часть 4: Интеграционные тесты

Проведение интеграционных тестов для проверки корректности работы всех компонентов проекта.

### Часть 5: Этап деплоя

Автоматизация деплоя проекта на целевые серверы после успешного прохождения всех тестов.

### Часть 6: Дополнительно - Уведомления

Настройка уведомлений в Telegram о статусе выполнения пайплайна (успех/неудача) с использованием бота.

## Обратная связь

Мы ценим вашу обратную связь по данному проекту. Пожалуйста, поделитесь своими мыслями и предложениями через [форму обратной связи](https://forms.yandex.ru/cloud/641819b3c09c022518e7a4f3/). Это поможет нам сделать обучение лучше.
